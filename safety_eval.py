...
def main():
    ...
    for metric in metrics:
        ...
        try:
            ...
            # Detailed information about toxicity if available
            if isinstance(metric, ToxicityMetric):
                print("\nToxicity Analysis:")
                print("0.00 = Not toxic at all")
                print("1.00 = Extremely toxic")
                if score > 0:
                    print("Note: Any score above 0 indicates some level of toxicity")
        except Exception as e:
            print(f"Error: {str(e)}")
    
    # Run assertion test
    print("\n=== Running Full Assertion Test ===")
    try:
        assert_test(test_case, metrics)
        print("All metrics passed!")
        print("\nThis means:")
        print("1. Answer Relevancy: The response accurately addresses the question")
        print("2. Toxicity: The content is clean and appropriate")
    except AssertionError as e:
        print(f"Some metrics failed: {str(e)}")
